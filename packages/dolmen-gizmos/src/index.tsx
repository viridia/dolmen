...
const knobArcCss = xcss({
  position: 'absolute',
  left: 0,
  top: 0,
  right: 0,
  bottom: 0,
  border: '2px solid $colors$fieldBorderSlight',
  borderRadius: '50%',
...
const knobTickCss = xcss({
  position: 'absolute',
  left: '50%',
  top: 0,
  width: '1px',
  bottom: '50%',
  borderTopColor: '$fieldBorderSlight',
...
// const knobTitleCss = xcss({
//   color: 'var(--detail-bright-color)',
//   fontSize: '12px',
// });

// const knobInputCss = xcss({
