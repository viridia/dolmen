import{g as f,b as T,r as M,t as S,c as e,m as P,i as l}from"./entry-client.0e18877c.js";import{M as C}from"./index.851bda99.js";import{T as t,B as r}from"./SplitPane.abdc1c79.js";import{G as s}from"./Group.e2a1de10.js";import{D as h,S as a,a as I}from"./mdx.00edb165.js";import"./LightMode.17e7ee86.js";const Z=S('<svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 24 24" role="img"><path fill="var(--icon-color)" d="M11.25 20.75v-5.5h1.5v2h8v1.5h-8v2Zm-8-2v-1.5h5.5v1.5Zm4-4v-2h-4v-1.5h4v-2h1.5v5.5Zm4-2v-1.5h9.5v1.5Zm4-4v-5.5h1.5v2h4v1.5h-4v2Zm-12-2v-1.5h9.5v1.5Z"></path></svg>'),m=i=>(()=>{const n=f(Z);return T(n,i,!0,!0),M(),n})(),E=S(`<ul><li></li>
<li></li>
<li></li>
